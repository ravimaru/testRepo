...
#.xcodeproj filename
projectFile='Pompah.xcodeproj'; readParameter projectFile 'sonar.swift.project'
workspaceFile='Pompah.xcworkspace'; readParameter workspaceFile 'sonar.swift.workspace'
